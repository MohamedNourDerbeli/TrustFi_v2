...
- [ ] 1. Create standardized contract fetching infrastructure
...
- [ ] 5. Audit and fix Dashboard page contract fetching
  - [ ] 5.1 Wrap all contract fetching calls with the new `useContractData` hook
  ...
  - [ ] 5.2 Implement parallel data fetching for independent data sources
  ...
  - [ ] 5.3 Add proper error boundaries around major sections
  ...
  - [ ] 5.4 Ensure activation prompt shows correctly for users without on-chain profiles
    - Check both off-chain and on-chain profile status
    - Display clear call-to-action for profile activation
    - _Requirements: 4.5_

- [ ] 6. Audit and fix Issuer page contract fetching
  - [ ] 6.1 Implement proper role-based access control
  ...
  - [ ] 6.2 Fix issued credentials history fetching
  ...
  - [ ] 6.3 Fix collectibles management data fetching
  ...
  - [ ] 6.4 Implement real-time updates after credential issuance
    - Refresh issued credentials list after successful issuance
    - Update statistics immediately
    - Show success feedback with transaction details
    - _Requirements: 5.5, 8.3_
  
  - [ ] 6.5 Add transaction status feedback for credential issuance
...
- [ ] 7. Audit and fix Admin page contract fetching
  - [ ] 7.1 Implement proper admin access control
...
- [ ] 8. Audit and fix Collectibles page contract fetching
  - [ ] 8.1 Fix collectibles list fetching
    - Wrap collectibles fetching in `useContractData` hook
    - Add loading skeleton for collectibles grid
    - Implement error handling with retry button
    - _Requirements: 9.1_
  
  - [ ] 8.2 Fix eligibility status fetching
    - Fetch eligibility status for all collectibles in parallel
    - Cache eligibility results to avoid redundant calls
    - Show loading state while checking eligibility
    - _Requirements: 9.1, 9.2_
  
  - [ ] 8.3 Implement proper filtering by claim status
  ...
  - [ ] 8.4 Implement collectible claiming flow with proper feedback
...
- [ ] 9. Enhance WalletContext for better state management
...
- [ ] 10. Implement service initialization checks
...
- [ ] 11. Add consistent navigation elements
